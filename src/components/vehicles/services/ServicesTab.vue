...
<template>
  ...
  <ul
    class="my-3 mb-14 md:mb-4 text-sm divide-y divide-neutral h-auto md:max-h-[70vh] overflow-y-auto"
  >
    <li
    ...
    >
      <div class="w-10 h-10 flex-none rounded-full border">
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          class="h-10 w-10 p-3 fill-current"
        >
          <path
      ...
      <div class="flex-1">
        ...
        <dl class="mt-2 flex flex-col xl:flex-row">
          ...
          <div
            class="mt-2 flex items-start space-x-2 xl:ml-3.5 xl:mt-0 xl:border-l xl:border-neutral xl:pl-3.5"
          >
            <dt class="mt-0.5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            ...
            class="mt-2 hidden md:flex items-start space-x-2 xl:ml-3.5 xl:mt-0 xl:border-l xl:border-neutral xl:pl-3.5"
          >
